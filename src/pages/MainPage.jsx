...
function MainPage() {
  ...
  return (
    <div className="bg-background min-h-screen">
      <div
        className=" font-Poppins max-w-full p-4 text-xl md:p-8 cursor-pointer "
        
      >
        <b>Github</b> Jobs
      </div>
      { error  != null && <div className="bg-primary text-sm rounded text-white  font-Poppins max-w-full p-4 mx-4 mb-4 md:p-8 md:mx-8 md:mb-8">
        { 
          <div>
          ...
          <br/>  
          <br/>  
          Note : <i> Due to exceeded of MONTHLY quota for Requests. You can not do more requests for the end of the month. </i> 
          <b><u>Currently it shows demo api data.</u></b>
         </div>
        }
      </div> }
